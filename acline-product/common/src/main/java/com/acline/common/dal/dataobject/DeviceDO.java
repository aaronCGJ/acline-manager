...
public class DeviceDO {
    ...
    public static final String RFID_NO = "rfidNo";
     ...
     * @param clientOwned
     */
    public void setClientOwned(Byte clientOwned) {
     ...
     * @param rackUnits
     */
    public void setRackUnits(Byte rackUnits) {
     ...
     */
    public void setDevicesDestroy(Byte devicesDestroy) {
    ...
    public String toString() {
        ...
        sb.append(", rfidNo=").append(rfidNo);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getDevId() == null ? other.getDevId() == null : this.getDevId().equals(other.getDevId()))
            ...
            && (this.getRfidNo() == null ? other.getRfidNo() == null : this.getRfidNo().equals(other.getRfidNo()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRfidNo() == null) ? 0 : getRfidNo().hashCode());
